      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center md:text-left">
          ...
          <ul className="space-y-2 text-sm text-slate-400">
            ...
            <li><span className="font-semibold text-slate-300">{t('contacts.phone')}:</span> +995591017945</li>
            <li><span className="font-semibold text-slate-300">Telegram:</span> @tosendme</li>
          </ul>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2">
            {/* Phone */}
            <a href="tel:+995591017945" className="text-white hover:text-lime-400 transition-colors duration-300">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/995591017945" target="_blank" rel="noopener noreferrer" className="text-white hover:text-lime-400 transition-colors duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-lime-500" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* Facebook */}
            <a href="#" className="text-white hover:text-lime-400 transition-colors duration-300">
